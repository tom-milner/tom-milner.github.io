...
<MuxPlayer
  playbackId="bMPJ9F6TscuJ01cUBsTNvyoibfd2ZHdGEbXjh9C28OtY"
  metadata={{ video_title: 'Inchworm Robot' }}
/>
...
import cycloid from "../../assets/inchworm_robot/Cycloidal_cam_mapped.png"
import sin from "../../assets/inchworm_robot/Sine_Squared_cam_mapped.png"

{/* <div class='horiz-stack'>  */}
  <Image src={cycloid} alt="Cycloid Cam Path"/>
  <Image src={sin} alt="Sinusoidal Cam Path" />
{/* </div>  */}
